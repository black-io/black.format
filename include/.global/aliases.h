...
inline namespace Global
{
	...
	*/
	...
	/**
		@brief	Platform-independent storage for Big-Endian integral value or enumeration.

		This value behaves like regular. It consumes values in platform-specific endianness. It can be implicitly converted to underlying value
		of platform-specific endianness. But internally it stored always in Big-Endian byte order.
